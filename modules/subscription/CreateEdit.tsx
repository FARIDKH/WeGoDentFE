...
const CreateEditForm = forwardRef(({ onSuccess }: IProps, ref) => {
    ...
    return (
        <Dialog
            sx={{ '& .MuiDialog-paper': { width: '60%', minHeight: !subscriptionData ? '400px' : '200px', textAlign: 'center' } }}
            maxWidth="lg"
            open={isOpen}
        >
            <Formik
                                    ...
                                    <Grid container spacing={10}>
                                        ...
                                        <Grid onClick={() => handleCardClick('PLAN_ECONOMIC')} sx={{ color: 'white' }} item xs={5}>
                                            ...
                                            >
                                                ...
                                                <Typography sx={{ color: 'white' }}>Top choice for early individual dentist</Typography>
